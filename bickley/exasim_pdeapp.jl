...
mesh.p, mesh.t = Mesh.SquareMesh(42,42,1); # a mesh of 8 by 8 quadrilaterals
...
pde.visscalars = ["tracer", 4];  # list of scalar fields for visualization
pde.visvectors = ["velocity", [2, 3]]; # list of vector fields for visualization
Postprocessing.vis(sol[:,:,:,1:jump:end],pde,mesh); # visualize the numerical solution
print("Done!");
println("Total time is ", (t2-t1)/60, " minutes")